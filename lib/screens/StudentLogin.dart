...
// final prefs = await SharedPreferences.getInstance();
  ...
  bool _validate(String s) {
    RegExp regExp = RegExp(r'^\d{2}bd[15]{1}[a-z]{1}\w{4}$',
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => home(
                passedNumber: (nameController.text).toUpperCase(),
                passedUrl: "NoData"),
          ));
    } else {
      CollectionReference addDetails =
          FirebaseFirestore.instance.collection('students');
      var users = await addDetails.add({
...
// print('Downlaoded Link : $urlDownload');
  ...
  Future<bool> uploadFile1() async {
    print("Came to execute uploADfILE1");
                                          ...
                                          Stack(
                                            children: [
                                              ClipRRect(
                                                ...
                                                //  child:  _loadingStart == false?Image.asset("assets/images/fever1.jpg",width: 130,height: 130,fit: BoxFit.cover,) : (_loading == true) ? (CircularProgressIndicator(backgroundColor: Color.fromARGB(255, 15, 15, 15),)) : (imageString!=null ? (Image.network(imageString!,width: 130,height: 130,fit: BoxFit.cover,)) : (imageFile!= null) ? (Image.file(imageFile!)) : (CircularProgressIndicator()))
                                                // child: changeScreen == true
                                                //     ? (imageFile != null
                                                //         ? (Image.file(
                                                //             imageFile!,
                                                //             width: 130,
                                                ...
                                                //   (imageFile==null) ?
                                                //  (Image.asset("assets/images/fever1.jpg",width: 130,height: 130,fit: BoxFit.cover)) :(Image.file(imageFile!,width: 130,height: 130,fit: BoxFit.cover,))),
                                                //         (imageFile != null) ?
                                                //         (changeScreen == true ?
